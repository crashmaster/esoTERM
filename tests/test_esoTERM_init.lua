...
describe("Test esoTERM initialization", function()
    ...
    local function and_esoTERM_event_handler_initialize_is_stubbed()
        ut_helper.stub_function(esoTERM_event_handler, "initialize", nil)
    end
    ...
    local function then_esoTERM_event_handler_initialize_was_called_once_with()
        assert.spy(esoTERM_event_handler.initialize).was.called_with()
    end
    ...
    function()
        given_that_esoTERM_addon_name_is(ADDON_NAME)
            and_esoTERM_event_handler_initialize_is_stubbed()
        ...
        then_esoTERM_event_handler_initialize_was_called_once_with()
