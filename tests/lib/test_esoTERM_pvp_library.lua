...
function test_esoTERM_pvp_library.given_that_module_is_set_inactive_in_the_config_file(...)
    test_library.set_module_to_inactive_in_config_file(...)
end

function test_esoTERM_pvp_library.given_that_module_is_set_active_in_the_config_file(...)
    test_library.set_module_to_active_in_config_file(...)
end

function test_esoTERM_pvp_library.and_ZO_SavedVars_new_was_called_with(...)
