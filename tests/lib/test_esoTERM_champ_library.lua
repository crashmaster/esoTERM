...
-- Module Name {{{
function test_esoTERM_champ_library.verify_that_module_has_the_expected_name(module, expected_name)
...
function test_esoTERM_champ_library.given_that_module_is_set_inactive_in_the_config_file(...)
    test_library.set_module_to_inactive_in_config_file(...)
end

function test_esoTERM_champ_library.given_that_module_is_set_active_in_the_config_file(...)
    test_library.set_module_to_active_in_config_file(...)
end

function test_esoTERM_champ_library.and_ZO_SavedVars_new_was_called_with(...)
...
function test_esoTERM_champ_library.and_active_state_of_the_module_was_saved()
    assert.is.equal(esoTERM_champ.settings[MODULE_NAME], true)
end

function test_esoTERM_champ_library.and_inactive_state_of_the_module_was_saved()
