...
local ESOTERM_EVENT_REGISTER = esoTERM_char.event_register
...
function esoTERM_char:enter_combat()
    ...
    esoTERM_common.register_for_event(ESOTERM_EVENT_REGISTER,
                                      EVENT_COMBAT_EVENT,
...
function esoTERM_char:exit_combat()
    ...
    esoTERM_common.unregister_from_event(ESOTERM_EVENT_REGISTER, EVENT_COMBAT_EVENT)
...
function esoTERM_char:deactivate()
    esoTERM_common.unregister_from_all_events(ESOTERM_EVENT_REGISTER)
